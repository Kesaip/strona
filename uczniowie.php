...
<div id="tresc_pracownicy">
    ...
    <center>
        ...
        <table class="table" style="text-align: center">
            ...
            $conn = polaczenieBaza();
            $Zapytanie =  "SELECT uczniowie.Nazwisko,uczniowie.Imie,uczniowie.uczenId,uczniowie.Email,klasy.klasa,klasy.klasaId,przydzial.klasa1,przydzial.uczen
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    $helena++;
                    echo "<tr><td>".$helena."</td><td>" . $row["Imie"]. "</td><td>" . $row["Nazwisko"] . "</td><td><a href='uczen.php?" . $row["uczenId"] ."'>" . $row["Email"] . "</a></td><td>" . $row["klasa"] ."</td><td> <a href='edytujUcznia.php?id=".$row["uczenId"]."'><i class='fa fa-pencil-square-o fa-2x' style='padding-right: 5px' aria-hidden='true'></i></a></td><td><a href='usunUcznia.php?id=".$row["uczenId"]."'><i class='fa fa-trash fa-2x' style='padding-left: 5px;color: rgb(255,30,30)' aria-hidden='true'></i></a></td></tr>";
                }
            } else {
                echo "0 results";
            }
