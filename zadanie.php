...
<table class="table">
    ...
    <tr>
        ...
        <?php if ($_SESSION['Id'] == $nauczyciel AND $_SESSION['zalogowany'] == 40 Or $_SESSION['zalogowany'] > 400 AND $_SESSION['zalogowany'] < 500) { ?>
    ...
    foreach ($files as $file) {
        ...
        if ($_SESSION['Id'] == $nauczyciel AND ($_SESSION['zalogowany'] == 40 OR $_SESSION['zalogowany'] > 400 AND $_SESSION['zalogowany'] < 500)) {
            echo '<td> 
